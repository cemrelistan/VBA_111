...
plt.title('Quarterly Counts for Climate Change Related Terms: Raw Data and 4-Quarter Rolling Mean', fontsize=14)
...
plt.tight_layout()
plt.savefig('grafikler/climate_change_time_series_line_plot.png')
plt.close()
